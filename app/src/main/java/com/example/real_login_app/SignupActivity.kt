...
class SignupActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.real_login_app.R.layout.sign_out_activity)
        ...
        _loginLink!!.setOnClickListener {
            ...
            finish()
            overridePendingTransition(com.example.real_login_app.R.anim.push_left_in, com.example.real_login_app.R.anim.push_left_out)
        }
    }
    ...
    fun signup() {
        ...
        val progressDialog = ProgressDialog(this@SignupActivity,
            com.example.real_login_app.R.style.Theme_AppCompat_DayNight_Dialog)
